...
<body>
    ...
    <div class="container" style="width: 65%">
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Cart_dog.php?action=add&id=<?php echo $row["id"]; ?>">
        ...
        <h3 class="title2">Shopping Cart_dog Details</h3>
